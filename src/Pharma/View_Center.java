...
public class View_Center {
	...
	public static void main(String[] args) throws Exception{
		...
		System.setProperty("webdriver.chrome.driver", "C:\\Users\\purnachander\\eclipse-workspace\\lib\\chromedriver.exe");
		...
		driver.findElement(By.id("search-record")).sendKeys("gsk");
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//a[@href=\"/pharma/center-listing/ONC_NET_00000010/Novartis%20Network%20\"])[3]")).click();
		Thread.sleep(3000);
		driver.findElement(By.xpath("//a[@href=\"/pharma/view-edit/ONC_CT_0000006\"]")).click();
		Thread.sleep(5000);
