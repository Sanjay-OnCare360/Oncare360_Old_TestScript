...
public class View_Network {
	...
	/*	
		...
		*/
		...
		user.sendKeys("sanofi@yopmail.com");
		driver.findElement(By.id("password")).sendKeys("Sanofi@123");
		driver.findElement(By.id("login-submit")).click();
		//logger.info("Login Successful");
		Thread.sleep(5000);
		
		driver.findElement(By.id("search-record")).sendKeys("NT000004");
		Thread.sleep(2000);
		driver.findElement(By.xpath("//img[@title=\"View Details\"]")).click();
		Thread.sleep(5000);
