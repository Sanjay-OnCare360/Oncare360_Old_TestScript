...
public class Center_Dashboard{
	public static void main(String[] args) throws Exception{
		...
		Logger logger=LogManager.getLogger(Center_Dashboard.class);
		...
		driver.findElement(By.id("search-record")).sendKeys("NT000016");//Search Network
		Thread.sleep(3000);
		driver.findElement(By.xpath("//a[.=' NT000016 ']")).click();//Redirect Network to Center 
		driver.findElement(By.id("search-record")).sendKeys("CT000015");//Search Center
		Thread.sleep(2000);
